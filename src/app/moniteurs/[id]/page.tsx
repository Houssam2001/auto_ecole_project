    ...
    <div className="h-full bg-gray-200 p-8">
        <div className="bg-white rounded-lg shadow-xl pb-8">
            ...
            <div className="w-full h-[250px]">
                <Image width={50} height={50} src="https://vojislavd.com/ta-template-demo/assets/img/profile-background.jpg" className="w-full h-full rounded-tl-lg rounded-tr-lg" alt={""}/>
            </div>
...
export default ProfileMoniteur