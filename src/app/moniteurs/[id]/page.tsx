...
export default function ProfileMoniteur({ params }: {
    ...
    const fetchClient = async () => {
        try {
            ...
            if (clientData) {
                setMoniteur(clientData); // Set the fetched client data
            } else {
                ...
                <div className="h-full bg-gray-200 p-8">
                            ...
                            <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                                ...
                                <ul className="mt-2 text-gray-700">
                                    <li className="flex border-y py-2">
                                        ...
                                        <span className="text-gray-700">{moniteur.nom}  {moniteur.prenom}</span>
                                    </li>
                                    ...
                                    <li className="flex border-b py-2">
                                        <span className="font-bold w-24">CIN:</span>
                    ...
                    {clients && (
                        <div className="bg-white rounded-lg shadow-xl p-8">
                            <div className="flex items-center justify-between">
                                <h4 className="text-xl text-gray-900 font-bold">Les clients ({clients.length})</h4>
