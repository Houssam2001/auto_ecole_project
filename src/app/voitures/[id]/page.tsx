                                    ...
                                    <div>
                                        <div className="relative w-full max-w-lg">
                                            ...
                                            <div className="relative">
                                                <Image width={50} height={50} className="object-cover object-center mx-auto rounded-lg shadow-2xl" alt="hero" src={`https://bkvsahkfjyxfeibvwrpm.supabase.co/storage/v1/object/public/machmech/${voiture.image}`} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
